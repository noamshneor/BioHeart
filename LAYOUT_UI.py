            ...
            [
                sg.Column(layout=[
                    ...
                    [
                        ...
                        sg.Combo(values=globals.hrv_methods_list, size=[200, 37], key='y axis', visible=True,
                    ...
                    [
                        ...
                        sg.Checkbox("Show baseline?", background_color='transparent', key='baseline checkbox',
                                    default=False,
                    ...
                    [
                        ...
                        sg.Listbox(values=globals.rides_list, size=[150, 57], key='rides listbox', visible=True,
                                   enable_events=True,
                                   font=("Century Gothic", 12),
                    ...
                    [
                        ...
                        sg.Radio(group_id="bar", text="Groups", background_color="transparent",
                                 ...
                                 enable_events=True, text_color='black', default=False),
                        sg.Radio(group_id="bar", text="All Participants", background_color="transparent",
                                 key="bar all", size=(250, 35), font=("Century Gothic", 14, 'bold'),
                                 enable_events=True, text_color='black', default=False),
                    ],
                    [
